change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/ProjectsData/defects_per_release.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/ProjectsData/defects_per_release.png")