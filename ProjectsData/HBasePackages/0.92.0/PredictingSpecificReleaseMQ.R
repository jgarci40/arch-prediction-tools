...
{
	model.lm <- lm(MQnextRelease ~ CountClassCoupled + MaxInheritanceTree + SumCyclomatic + 
    NumCochangedFiles + BDC + BUO + incomingDep + outgoingDep + 
    internalEdges + edgesInto, data=train)
