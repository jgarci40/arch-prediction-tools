...
{  
    ...
    1) + log2(coChangedSamePackage + 1) + log2(internalEdges + 
    1) + log2(externalEdges + 1), data=train)	
...
{
	model.lm <- lm(BugCountMult ~ LOC + numberOfCommits + CountClassCoupled + SumCyclomatic + 
