...
{  
	model.glm.nb <- glm.nb(newBUO ~ log2(LOC + 1) + log2(numberOfCommits + 1) + log2(coChangedSamePackage + 
...
{
	model.lm <- lm(newBUO ~ PercentLackOfCohesion + BCO + SPF + BDC + BUO + incomingDep + 
