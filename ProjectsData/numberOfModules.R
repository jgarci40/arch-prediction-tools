library(ggplot2)
change<-read.csv("/Users/joshua/ser_home/projects/arch_prediction/PerRelease/ProjectsData/numberOfModules.csv",header=T)
...
ggsave(file="/Users/joshua/ser_home/projects/arch_prediction/PerRelease/ProjectsData/numberOfModules.png")