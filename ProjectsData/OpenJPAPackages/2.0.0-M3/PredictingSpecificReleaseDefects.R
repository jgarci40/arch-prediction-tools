...
{  
    ...
    1) + log2(incomingDep + 1) + log2(outgoingDep + 1) + log2(internalEdges + 
...
{
	model.lm <- lm(BugCountMult ~ LOC + numberOfCommits + coChangedDifferentPackage + 
    incomingDep + internalEdges + externalEdges, data=train)
