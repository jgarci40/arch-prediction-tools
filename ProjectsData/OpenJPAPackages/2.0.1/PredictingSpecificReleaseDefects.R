...
{  
    ...
    1) + log2(outgoingDep + 1) + log2(internalEdges + 1), data=train)	
...
{
	model.lm <- lm(BugCountMult ~ LOC + numberOfCommits + MaxInheritanceTree + SumCyclomatic + 
    NumCochangedFiles + incomingDep, data=train)
