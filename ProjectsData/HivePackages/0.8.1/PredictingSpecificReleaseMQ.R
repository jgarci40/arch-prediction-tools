...
{
	model.lm <- lm(MQnextRelease ~ CountClassCoupled + PercentLackOfCohesion + NumCochangedFiles + 
    coChangedDifferentPackage + BDC + incomingDep + internalEdges + 
    externalEdges + edgesInto, data=train)
