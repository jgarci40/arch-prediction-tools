change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/ProjectsData/smells_per_release.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/ProjectsData/smells_per_release.png")