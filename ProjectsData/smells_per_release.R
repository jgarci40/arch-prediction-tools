library(ggplot2)
change<-read.csv("/Users/joshua/ser_home/projects/arch_prediction/PerRelease/ProjectsData/smells_per_release.csv",header=T)
p<-ggplot(change, aes(x= Projects, y= Smells, fill= Projects)) + geom_boxplot(width = 0.6) + xlab("") +
...
ggsave(file="/Users/joshua/ser_home/projects/arch_prediction/PerRelease/ProjectsData/smells_per_release.png")