...
options(digits=2)
  ...
  change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/ClusterFactorAUC.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/ClusterFactorAUC.png")
