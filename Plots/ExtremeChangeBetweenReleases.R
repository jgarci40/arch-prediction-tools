...
change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/ExtremeChangeBetweenReleases.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/ExtremeChangeBetweenReleases.png")