...
change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/ClusterFactor.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/ClusterFactor.png")