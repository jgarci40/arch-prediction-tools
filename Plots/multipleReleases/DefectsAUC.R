...
change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/multipleReleases/DefectsAUC.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/multipleReleases/DefectsAUC.png")
