...
change<-read.csv("/Users/Ehsan/Workspace/RData/Scripts/PerRelease/Plots/multipleReleases/DefectsAUC.csv",header=T)
...
ggsave(file="/Users/Ehsan/Workspace/RData/Scripts/PerRelease/Plots/multipleReleases/DefectsAUC.png")
