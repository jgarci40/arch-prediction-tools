...
options(digits=2)
  ...
  change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/multipleReleases/ClusterFactorAUC.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/multipleReleases/ClusterFactorAUC.png")
