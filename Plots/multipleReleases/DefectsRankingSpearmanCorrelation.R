...
change<-read.csv("/Users/Ehsan/Workspace/RData/Scripts/PerRelease/Plots/multipleReleases/DefectsRankingSpearmanCorrelation.csv",header=T)
...
ggsave(file="/Users/Ehsan/Workspace/RData/Scripts/PerRelease/Plots/multipleReleases/DefectsRankingSpearmanCorrelation.png")
