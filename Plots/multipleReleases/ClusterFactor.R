...
change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/multipleReleases/ClusterFactor.csv",header=T)
p<-ggplot(change, aes(x= Models, y= Spearman, fill= Models)) + geom_boxplot(width = 0.5) + xlab("") +
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/multipleReleases/ClusterFactor.png")