...
change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/ProjectsData/cf_spearman.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/ProjectsData/cf_spearman.png")