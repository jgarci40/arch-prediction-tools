...
change<-read.csv("/Users/Ehsan/Workspace/RData/Scripts/PerRelease/Plots/multipleReleases/ClusterFactor.csv",header=T)
...
ggsave(file="/Users/Ehsan/Workspace/RData/Scripts/PerRelease/Plots/multipleReleases/ClusterFactor.png")