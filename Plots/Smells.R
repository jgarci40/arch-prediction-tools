...
change<-read.csv("/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/Smells.csv",header=T)
...
ggsave(file="/Users/joshua/ser/projects/arch_prediction/PerRelease/Plots/Smells.png")
